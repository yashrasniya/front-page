...
document.getElementById("soth").addEventListener("focusout", () => {
    document.getElementById("subOp").value = document.getElementById("soth").value;
    document.getElementById("sub").style.display = "";
});
...
document.getElementById("foth").addEventListener("focusout", () => {
    document.getElementById("facOp").value = document.getElementById("foth").value;
    document.getElementById("fac").style.display = "";
});